...
本软件仅供教育和授权测试用途。作者和贡献者不对任何因使用本
工具而造成的误用或损害负责。

- 你只能在自有系统或已获得明确书面授权的系统上使用 `ish`。
- 未经授权访问计算机系统在大多数司法管辖区属于违法行为。
  在进行安全测试前，务必取得合法授权。
- 本工具旨在协助安全专业人员及 AI agent 在渗透测试过程中管理
  交互式 shell 会话，并非为协助未授权访问而设计。
- 使用本软件即表示你对自己的行为承担全部责任，并同意遵守所有
  适用的地方、州、国家及国际法律法规。

本软件按"原样"提供，不附带任何形式的明示或暗示担保，包括但不
限于对适销性、特定用途适用性及非侵权性的担保。在任何情况下，
作者或版权持有人均不对因使用本软件而产生的任何索赔、损害或
其他责任承担责任，无论是在合同诉讼、侵权行为或其他诉讼中。
